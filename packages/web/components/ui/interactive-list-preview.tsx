...
const DEFAULT_ITEMS: InteractiveListItem[] = [
  { client: "EXC-01", platform: "KOMATSU PC200-8", services: "Excavator, Hour-meter logs, Photo evidence", img: "/fleet/exc-01.jpg" },
  { client: "EXC-02", platform: "HITACHI ZX200-5G", services: "Excavator, Predictive alerts, Audit trail", img: "/fleet/exc-02.jpg" },
  { client: "DZR-01", platform: "KOMATSU D65EX", services: "Dozer, Maintenance tasks, Auto invoicing", img: "/fleet/dzr-01.jpg" },
  { client: "DTR-01", platform: "TATA SIGNA 2518", services: "Dump truck, Daily logs, Multi-site billing", img: "/fleet/dtr-01.jpg" },
  { client: "DTR-02", platform: "BHARATBENZ 2823R", services: "Dump truck, Row-level security, FX billing", img: "/fleet/dtr-02.jpg" },
];
